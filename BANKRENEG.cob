      *================================================================
      * BANKRENEG.COB - Renegociacao de Dividas
      ...
      *================================================================
       6000-INICIO.
           ...
           IF RENEG-STATUS NOT = 'A'
               ...
               EXIT SECTION
           END-IF
      *    Desconto adicional de 10% para quitacao a vista do saldo
           ...
           IF WS-OPCAO = 'S'
               ...
               DISPLAY 'Seu nome sera regularizado nos orgaos de protecao'
               MOVE 0 TO LS-CODIGO
           ELSE
               DISPLAY 'OPERACAO ABORTADA'
           END-IF.
      ...
      *================================================================
      *    Quanto maior o atraso, maior o desconto oferecido
           EVALUATE TRUE
